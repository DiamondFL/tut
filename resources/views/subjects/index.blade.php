...
<form class="form-group row" id="formFilter" action="{{route('subjects.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        <a class="btn btn-primary" href="{{route('subjects.create')}}"><i class="fa fa-plus"></i></a>
