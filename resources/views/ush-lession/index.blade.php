...
<div class="row">
    <ol class="breadcrumb bc-3">
        ...
        <li>
            <a href="{{route('ush-lession.index')}}">ush_lessions</a>
        </li>
        <li class="active">
            <strong>Table</strong>
        </li>
    ...
    <form class="form-group" id="formFilter" action="{{route('ush-lession.index')}}" method="POST">
        ...
        <!--</div>-->
        <div class="col-sm-2 form-group">
            <a class="btn btn-primary" href="{{route('ush-lession.create')}}"><i class="fa fa-plus"></i></a>
            <!--<a class="btn btn-danger"><i class="fa fa-trash"></i></a>-->
        </div>
    </form>
    <div class="box-content nopadding" id="table">
        @include('doc::ush-lession.table')
    </div>
</div>
@endsection
