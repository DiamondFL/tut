...
<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="{{route('create.index')}}">create</a>
    </li>
    <li class="active">
        <strong>Tables</strong>
    </li>
</ol>
<form class="form-group row" id="formFilter" action="{{route('create.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        @can('create', $create)
        <a class="btn btn-primary" href="{{route('create.create')}}"><i class="fa fa-plus"></i></a>
        @endcan
        @can('delete', $create)
