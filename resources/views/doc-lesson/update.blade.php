...
<div class="row">
    <ol class="breadcrumb bc-3">
        ...
        <li>
            <a href="{{route('doc-lesson.index')}}">_name_</a>
        </li>
        <li class="active">
            <strong>Table</strong>
        </li>
...
<div class="form-group col-lg-6">
    ...
    <input type="number" class="form-control" name="sub_category_id"  id="sub_category_id" value="{{$docLesson->sub_category_id}}">
</div>
<div class="form-group col-lg-6">
    <label for="views">{{trans('label.views')}}</label>
    <input type="number" class="form-control" name="views"  id="views" value="{{$docLesson->views}}">
</div>
<div class="form-group col-lg-6">
    <label for="last_view">{{trans('label.last_view')}}</label>
    <input type="datetime" class="form-control" name="last_view"  id="last_view" value="{{$docLesson->last_view}}">
</div>
<div class="form-group col-lg-6">
    <label for="created_by">{{trans('label.created_by')}}</label>
    <input type="number" class="form-control" name="created_by"  id="created_by" value="{{$docLesson->created_by}}">
</div>
<div class="form-group col-lg-6">
    <label for="updated_by">{{trans('label.updated_by')}}</label>
    <input type="number" class="form-control" name="updated_by"  id="updated_by" value="{{$docLesson->updated_by}}">
</div>
