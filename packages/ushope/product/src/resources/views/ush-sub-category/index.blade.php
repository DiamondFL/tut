...
@section('content')
    <ol class="breadcrumb bc-3">
        ...
        <li>
            <a href="{{route('ush-sub-category.index')}}">ush_sub_categories</a>
        </li>
        <li class="active">
            <strong>Table</strong>
        </li>
    </ol>
    <form class="form-group row" id="formFilter" action="{{route('ush-sub-category.index')}}" method="POST">
        ...
        <div class="col-sm-2 form-group">
            <a class="btn btn-primary" href="{{route('ush-sub-category.create')}}"><i class="fa fa-plus"></i></a>
            <a class="btn btn-danger"><i class="fa fa-trash"></i></a>
        </div>
    </form>
    <div class="box-content nopadding" id="table">
        @include('ush-p::ush-sub-category.table')
    </div>
@endsection
