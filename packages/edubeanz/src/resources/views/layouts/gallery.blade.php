...
<head>
	...
	<link rel="stylesheet" href="{{asset('')}}assets/js/nivo-lightbox/nivo-lightbox.css">
	<link rel="stylesheet" href="{{asset('')}}assets/js/nivo-lightbox/themes/default/default.css">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="gallery-item">
					<a href="{{asset('')}}assets/images/portfolio-img-large-1.png" data-lightbox-gallery="gallery1" class="image" title="Athletica">
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="gallery-item">
					<a href="{{asset('')}}assets/images/portfolio-img-large-1.png" data-lightbox-gallery="gallery1" class="image" title="T Shirt">
						<img src="assets/images/gallery-thumb.png" class="img-rounded" />
						<span class="hover-zoom"></span>
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="gallery-item">
					<a href="{{asset('')}}assets/images/portfolio-img-large-1.png" data-lightbox-gallery="gallery1" class="image" title="Team">
						<img src="assets/images/gallery-thumb.png" class="img-rounded" />
						<span class="hover-zoom"></span>
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="gallery-item">
					<a href="{{asset('')}}assets/images/portfolio-img-large-1.png" data-lightbox-gallery="gallery1" class="image" title="Team play">
						<img src="assets/images/gallery-thumb.png" class="img-rounded" />
						<span class="hover-zoom"></span>
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="gallery-item">
					<a href="{{asset('')}}assets/images/portfolio-img-large-1.png" data-lightbox-gallery="gallery1" class="image" title="Branded Wall">
						<img src="assets/images/gallery-thumb.png" class="img-rounded" />
						<span class="hover-zoom"></span>
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="gallery-item">
					<a href="{{asset('')}}assets/images/gallery-img-large.jpg" data-lightbox-gallery="gallery1" class="image" title="San Francisco">
						<img src="assets/images/gallery-thumb.png" class="img-rounded" />
						<span class="hover-zoom"></span>
