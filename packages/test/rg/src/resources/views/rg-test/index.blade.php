...
<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="{{route('rg-test.index')}}">rg_tests</a>
    </li>
    <li class="active">
        <strong>Table</strong>
    </li>
</ol>
<form class="form-group row" id="formFilter" action="{{route('rg-test.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        <a class="btn btn-primary" href="{{route('rg-test.create')}}"><i class="fa fa-plus"></i></a>
        <a class="btn btn-danger"><i class="fa fa-trash"></i></a>
    </div>
</form>
<div class="box-content nopadding" id="table">
    @include('trg::rg-test.table')
</div>
@endsection
