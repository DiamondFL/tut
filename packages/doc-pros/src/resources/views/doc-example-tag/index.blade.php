...
<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="{{route('doc-example-tag.index')}}">doc_example_tags</a>
    </li>
    <li class="active">
        <strong>Table</strong>
    </li>
</ol>
<form class="form-group row" id="formFilter" action="{{route('doc-example-tag.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        <a class="btn btn-primary" href="{{route('doc-example-tag.create')}}"><i class="fa fa-plus"></i></a>
        <a class="btn btn-danger"><i class="fa fa-trash"></i></a>
    </div>
</form>
<div class="box-content nopadding" id="table">
    @include('doc::doc-example-tag.table')
</div>
@endsection
