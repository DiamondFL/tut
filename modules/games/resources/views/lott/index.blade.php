...
@section('container')
   <div class="col-md-12">
       <h1 style="font-style: italic" class="text-info text-center">Portal lott 6x25</h1>
       ...
       <form action="{{route('lott.play')}}" method="POST" class="col-md-8 col-md-offset-2">
           ...
           <div class="row form-group">
               @for($i = 1; $i < 7; $i++)
                   <div class="col-md-2">
                       <input value="{{$lotts[$i - 1]}}" required type="number" min="0" max="25" class="form-control" name="lott[]">
                   </div>
               @endfor
           </div>
           @else
