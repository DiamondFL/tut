       ...
       <form action="{{route('parity.play')}}" method="POST" class="col-md-4 col-md-offset-4">
           ...
           <ul class="list-group">
               <li class="list-group-item">Chẵn
                   <input required type="radio" value="1" class="pull-right" name="betting">
               </li>
               <li class="list-group-item">lẻ
                   <input required type="radio" value="0" class="pull-right" name="betting">
               </li>
           </ul>
           ...
           <div class="form-group">
               ...
               <p class="text-warning">Sử dụng tuyệt chiêu. Siêu vô địch đắc thắng thủ.</p>
           </div>
