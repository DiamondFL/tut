...
<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="{{route('doc-news-tag.index')}}">doc_news_tags</a>
    </li>
    <li class="active">
        <strong>Table</strong>
    </li>
</ol>
<form class="form-group row" id="formFilter" action="{{route('doc-news-tag.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        <a class="btn btn-primary" href="{{route('doc-news-tag.create')}}"><i class="fa fa-plus"></i></a>
        <a class="btn btn-danger destroyBtn"><i class="fa fa-trash"></i></a>
    </div>
</form>
<div class="box-content nopadding" id="table">
    @include('doc::doc-news-tag.table')
</div>
@endsection
