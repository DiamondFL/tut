...
<form class="form-group row" id="formFilter" action="{{route('doc-example.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        <a class="btn btn-primary" href="{{route('doc-example.create')}}"><i class="fa fa-plus"></i></a>
        <a class="btn btn-danger destroyBtn"><i class="fa fa-trash"></i></a>
    </div>
</form>
<div class="box-content nopadding" id="table">
    @include('doc::doc-example.table')
</div>
@endsection
