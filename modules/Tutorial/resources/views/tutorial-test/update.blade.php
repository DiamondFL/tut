...
<div class="row">
    ...
    <div class="checkbox">
        <label>
            <input type="checkbox" name="tutorial_id"  id="tutorial_id" value="{{$tutorialTest->tutorial_id}}">
        </label>
    </div>
</div>
<div class="form-group col-lg-12">
    <label for="questions">{{trans('label.questions')}}</label>
    <textarea class="form-control ckeditor" name="questions"  id="questions">{{$tutorialTest->questions}}</textarea>
</div>
<div class="form-group col-lg-6">
