...
<div class="row">
    <ol class="breadcrumb bc-3">
        ...
        <li>
            <a href="{{route('lesson-result.index')}}">_name_</a>
        </li>
        <li class="active">
            <strong>Table</strong>
        </li>
    ...
    <input type="number" class="form-control" name="created_by"  id="created_by" value="{{$lessonResult->created_by}}">
</div>
<div class="form-group col-lg-6">
    <label for="lesson_id">{{trans('label.lesson_id')}}</label>
    <input type="number" class="form-control" name="lesson_id"  id="lesson_id" value="{{$lessonResult->lesson_id}}">
</div>
<div class="form-group col-lg-6">
