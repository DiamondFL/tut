...
<div class="form-group col-lg-12">
    ...
    <textarea class="form-control ckeditor" name="questions"  id="questions">{{$sectionTest->questions}}</textarea>
</div>
<div class="form-group col-lg-6">
    <label for="reply1">{{trans('label.reply1')}}</label>
    <input type="text" class="form-control" name="reply1"  id="reply1" value="{{$sectionTest->reply1}}" >
</div>
<div class="form-group col-lg-6">
    <label for="reply2">{{trans('label.reply2')}}</label>
    <input type="text" class="form-control" name="reply2"  id="reply2" value="{{$sectionTest->reply2}}" >
</div>
<div class="form-group col-lg-6">
    <label for="reply3">{{trans('label.reply3')}}</label>
    <input type="text" class="form-control" name="reply3"  id="reply3" value="{{$sectionTest->reply3}}" >
</div>
<div class="form-group col-lg-6">
    <label for="reply4">{{trans('label.reply4')}}</label>
    <input type="text" class="form-control" name="reply4"  id="reply4" value="{{$sectionTest->reply4}}" >
</div>
<div class="form-group col-lg-6">
