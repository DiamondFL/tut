    ...
    <div class="row">
        <form action="{{route('permissions.update', $permission->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-lg-6">
                ...
                <input type="text" class="form-control" value="{{$permission->display_name}}" name="display_name" id="display_name">
            </div>
            <div class="form-group col-lg-12">
                <label for="description">{{trans('label.description')}}</label>
                <textarea type="text" class="form-control ckeditor" name="description" id="description">
            ...
            <div class="form-group col-lg-12">
                ...
                <div>
                    <div class="make-switch switch-small" data-on-label="<i class='entypo-check'></i>"
                        ...
                        <input type="checkbox" name="is_active" @if($permission->is_active == 1) checked @endif value="1" />
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
