...
class DocController extends Controller
{
    ...
    public function index()
    {
        $categories = app(Categories::class)
            ->select(['id', 'name'])
            ->get();
        return view('edu::doc.index', compact('categories'));
    }
    public function show($id)
    {
        ...
        $subCategories = app(SubCategories::class)
            ...
            ->get();
//        dump($subCategories);
        return view('edu::doc.show', compact('subCategories', 'category'));
    }
    public function section($id)
    {
        $subCategories = app(SubCategories::class)
            ...
            ->withCount('lessons')
            ->get(['id', 'name']);
        return view('edu::doc.section', compact('subCategories'));
    }
...
//        dd($section);
        ...
        return view('edu::doc.lesson', $data);
    }
}
