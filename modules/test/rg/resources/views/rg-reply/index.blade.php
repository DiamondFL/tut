...
<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="{{route('rg-reply.index')}}">rg_replies</a>
    </li>
    <li class="active">
        <strong>Table</strong>
    </li>
</ol>
<form class="form-group row" id="formFilter" action="{{route('rg-reply.index')}}" method="POST">
    ...
    <div class="col-sm-2 form-group">
        <a class="btn btn-primary" href="{{route('rg-reply.create')}}"><i class="fa fa-plus"></i></a>
        <a class="btn btn-danger destroyBtn"><i class="fa fa-trash"></i></a>
    </div>
</form>
<div class="box-content nopadding" id="table">
    @include('trg::rg-reply.table')
</div>
@endsection
