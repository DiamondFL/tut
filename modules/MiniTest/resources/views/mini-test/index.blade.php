...
@section('content')
    ...
    <form class="form-group row" id="formFilter" action="{{route('mini-test.index')}}" method="POST">
        ...
        <!--</div>-->
        <div class="col-sm-2 form-group">
            <a class="btn btn-primary" href="{{route('mini-test.create')}}"><i class="fa fa-plus"></i></a>
            <!--<a class="btn btn-danger"><i class="fa fa-trash"></i></a>-->
        </div>
    </form>
    <div class="box-content nopadding" id="table">
        @include('mini-test::mini-test.table')
    </div>
@endsection
